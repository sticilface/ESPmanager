 ...
 ****************************************************/
    ...
    function getGenvars() {
        $.getJSON("/espman/data.esp?plain=WiFiDetails", function(result) {
...
$(document).on("pagecreate", "#wifipage", function() {
  ...
  var globalwifi; 
    ...
    function refreshAPlist() {
        $.getJSON("/espman/data.esp?plain=PerformWiFiScan", function(result) {
 ...
 function getWiFiVars(scan) {
        ...
        var request;
        if (scan) {
            request = "/espman/data.esp?plain=PerformWiFiScan";
        }
        if (!scan) {
            request = "/espman/data.esp?plain=WiFiDetails";
        }
...
$(document).on("pagecreate", "#aboutpage", function() {
    ...
    function GetAboutVars() {
        $.getJSON("/espman/data.esp?plain=AboutPage", function(results) {
            $("#aboutvars").empty();
